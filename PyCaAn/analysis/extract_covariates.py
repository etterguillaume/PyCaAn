...
def extract_covariates_session(data, params):
    ...
    if (
        not os.path.exists(os.path.join(working_directory, "covariates.h5"))
        ...
        if (
            data["task"] == "legoLT"
            or data["task"] == "legoToneLT"
            or data["task"] == "legoSeqLT"
        ):
            mazeSize = 134
        ...
        info_matrix[1, 0], pvalue_matrix[1, 0], correlation_matrix[1, 0] = (
            info_matrix[0, 1],
            pvalue_matrix[0, 1],
            correlation_matrix[0, 1],
        )
        ...
        info_matrix[2, 0], pvalue_matrix[2, 0], correlation_matrix[2, 0] = (
            info_matrix[0, 2],
            pvalue_matrix[0, 2],
            correlation_matrix[0, 2],
        )
        ...
        info_matrix[3, 0], pvalue_matrix[3, 0], correlation_matrix[3, 0] = (
            info_matrix[0, 3],
            pvalue_matrix[0, 3],
            correlation_matrix[0, 3],
        )
        ...
        if (
            ...
            info_matrix[4, 0], pvalue_matrix[4, 0], correlation_matrix[4, 0] = (
                info_matrix[0, 4],
                pvalue_matrix[0, 4],
                correlation_matrix[0, 4],
            )
        ...
        info_matrix[2, 1], pvalue_matrix[2, 1], correlation_matrix[2, 1] = (
            info_matrix[1, 2],
            pvalue_matrix[1, 2],
            correlation_matrix[1, 2],
        )
        ...
        info_matrix[3, 1], pvalue_matrix[3, 1], correlation_matrix[3, 1] = (
            info_matrix[1, 3],
            pvalue_matrix[1, 3],
            correlation_matrix[1, 3],
        )
        ...
        if (
            ...
            info_matrix[4, 1], pvalue_matrix[4, 1], correlation_matrix[4, 1] = (
                info_matrix[1, 4],
                pvalue_matrix[1, 4],
                correlation_matrix[1, 4],
            )
        ...
        info_matrix[3, 2], pvalue_matrix[3, 2], correlation_matrix[3, 2] = (
            info_matrix[2, 3],
            pvalue_matrix[2, 3],
            correlation_matrix[2, 3],
        )
        ...
        if (
            ...
            info_matrix[4, 2], pvalue_matrix[4, 2], correlation_matrix[4, 2] = (
                info_matrix[2, 4],
                pvalue_matrix[2, 4],
                correlation_matrix[2, 4],
            )
        ...
        if (
            ...
            info_matrix[4, 3], pvalue_matrix[4, 3], correlation_matrix[4, 3] = (
                info_matrix[3, 4],
                pvalue_matrix[3, 4],
                correlation_matrix[3, 4],
            )
