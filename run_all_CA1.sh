...
python3 run_analysis.py --param_file 'params_CA1.yaml' --extract_basic_info --extract_tuning  --extract_embedding --decode_embedding --fit_model --extract_internal_tuning
